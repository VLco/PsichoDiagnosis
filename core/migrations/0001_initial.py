# Generated by Django 3.0.6 on 2020-07-23 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Conviction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Conviction')),
                ('Rule', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Rule')),
                ('Symptom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Symptom')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='doctor',
            name='Patient',
            field=models.ManyToManyField(through='core.PatientList', to='core.PatientRecord'),
        ),
        migrations.AddField(
